...
<body>
  ...
  <!--  <input type="search" id="maRecherche" class="search" name="q"
    ...
    <a href="profil.html"><img id="image1" src="vous.png" alt="Profil" width="98" height="57" onmouseenter ="changeImage2(this)"/></a>
    <a href="reseau.html"><img id="image2" src="reseau.png" alt="Reseau" width="98" height="57" onmouseenter ="changeImage3(this)"/></a>
  ...
  <strong class="gwd-strong-kwsw"><?php echo $name ?><br>
  <span class="gwd-span-hb4w"><?php $poste, " à ", $entreprise ?><br>Bonjour!<br><br><br><br><br><br><br><br><br></span>
